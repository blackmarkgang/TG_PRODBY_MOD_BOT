...
Нажмите <b>«Подать заявку»</b>, чтобы начать 👇""",
    ...
    BotTextDefinition(
        ...
        "Ответ, если пользователь прислал меньше минимального количества символов.",
        "✍️ <b>Ответ слишком короткий</b>\n\nНапишите не менее <b>{min_length}</b> символов.",
        ("min_length",),
    ),
    BotTextDefinition(
    ...
    BotTextDefinition(
        ...
        "Анкета",
        "Вопрос с файлами",
        "Шаблон вопроса анкеты с типом «Файл».",
        "📎 <b>{question}</b>\n\n<i>Шаг {step} из {total}</i>\n\n{help_text}\n\nПрикрепите от <b>{min_attachments}</b> до <b>{max_attachments}</b> файлов. Ссылки не принимаются. Размер одного файла — не более <b>10 МБ</b>. Кнопка <b>«Готово»</b> появится после второго файла.",
        ("question", "help_text", "step", "total", "min_attachments", "max_attachments"),
    ),
    BotTextDefinition(
        "attachment_limit",
        "Анкета",
    ...
    BotTextDefinition(
        ...
        "⚠️ <b>Нужен файл</b>\n\nОтправьте файл, аудио, видео или фото. Ссылки и текст не принимаются. Нужно прикрепить минимум два файла.",
    ),
    BotTextDefinition(
    ...
    BotTextDefinition(
        ...
        "⚠️ <b>Файл слишком большой</b>\n\nРазмер одного файла не должен превышать <b>10 МБ</b>. Отправьте файл меньшего размера.",
    ),
    BotTextDefinition(
        "attachment_minimum",
        "Анкета",
        "Недостаточно вложений",
        "Ответ при попытке завершить файловый вопрос раньше минимального количества.",
        "📎 <b>Нужно больше примеров работ</b>\n\nПрикрепите минимум <b>{min_attachments}</b> файла. Сейчас добавлено: <b>{count}</b>.",
        ("count", "min_attachments"),
    ),
    BotTextDefinition(
        "attachment_added",
        "Анкета",
        "Вложение добавлено",
        "Подтверждение после добавления файла.",
        "✅ <b>Вложение добавлено</b>\n\nСейчас в заявке: <b>{count} из {max_attachments}</b>. Минимум: <b>{min_attachments}</b>. После второго файла можно завершить этот шаг.",
        ("count", "min_attachments", "max_attachments"),
    ),
    BotTextDefinition(
        "user_unknown",
        "Анкета",
    ...
    BotTextDefinition(
        ...
        "Решения",
        "Заявка аннулирована",
        "Уведомление после аннулирования одобренной заявки.",
        "↩️ <b>Ваша заявка в Prod.by аннулирована</b>\n\nТеперь вы можете повторно заполнить анкету. Отправьте /start и нажмите <b>«Подать заявку»</b>.",
    ),
    BotTextDefinition(
        "user_banned",
        "Решения",
