...
Нажмите <b>«Подать заявку»</b>, чтобы начать 👇""",
    ...
    BotTextDefinition(
        ...
        "📎 <b>{question}</b>\n\n<i>Шаг {step} из {total}</i>\n\n{help_text}\n\nПрикрепите до {max_attachments} файлов. Ссылки не принимаются. Размер одного файла — не более <b>10 МБ</b>. Можно продолжить без вложений — нажмите <b>«Пропустить вложения»</b>.",
        ("question", "help_text", "step", "total", "max_attachments"),
    ),
    BotTextDefinition(
        "attachment_limit",
        "Анкета",
    ...
    BotTextDefinition(
        ...
        "⚠️ <b>Нужен файл</b>\n\nОтправьте файл, аудио, видео или фото. Ссылки и текст не принимаются. Для завершения нажмите <b>«Готово»</b>.",
    ),
    BotTextDefinition(
